...
const sizeMap = {
 ...
 nav: {
  full: "h-[calc(var(--header-height)-0.85rem)] w-auto max-w-[11.5rem] sm:max-w-[13.5rem] lg:max-w-[15rem]",
  mark: "h-[calc(var(--header-height)-0.85rem)] w-auto max-w-[2.75rem] sm:max-w-[3.25rem]",
 },
