        ...
        <div className="grid items-stretch gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 xl:gap-16">
          ...
          <div className="flex flex-col justify-center">
            <Reveal>
              ...
              <h2 className="mt-3 max-w-[20ch] font-sans text-[clamp(1.75rem,3.6vw,2.75rem)] font-semibold leading-[1.05] tracking-[-0.035em] text-mehr-ink">
                {story.title}
              </h2>
              <div className="mt-5 space-y-3.5 max-w-xl">
                {story.body.map((para) => (
                  <p
                    key={para}
                    className="text-[14px] leading-relaxed text-mehr-mist sm:text-[15px]"
                  >
                    {para}
                  </p>
                ))}
            ...
            <Reveal delay={0.12}>
              <blockquote className="mt-8 border-l-[3px] border-mehr-deep pl-5 sm:pl-6">
